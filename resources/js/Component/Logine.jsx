...
import logoLogine from './Image/dev3.jpg';
import './Logine.css';
                ...
                <section className="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
                    <div className="login-content container">
                        <div className="row justify-content-center bg-transparent">
                            <div className="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center bg-transparent">
                                <div className="card mb-3 " >
                                    <div className="card-body">
                                        <div className="pt-4 pb-2">
                                            <div className="d-flex justify-content-center py-4">
                                                <img src={logoLogine} alt="Logo" style={{ width: 80, height: 70, borderRadius: 55 }} />
                                            </div>
